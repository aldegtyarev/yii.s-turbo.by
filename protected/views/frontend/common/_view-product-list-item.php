		...
		<div class="product-bottom clearfix">
			<div class="product-prices">
				<?//if($data->product_override_price != 0) {	?>
					<p class="c_d70000 bold font-20"><?=number_format($data->product_price, 1, '.', ' ')?> у.е.</p>
					<p class="c_000 bold font-12 mt-10"><?=number_format(($data->product_price * Yii::app()->params->usd_rate), 0, '.', ' ')?> бел.руб</p>
				<?	//}	else	{	?>
