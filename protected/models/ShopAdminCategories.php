...
/**
 * This is the model class for table "{{shop_admin_categories}}".
 *
 * The followings are the available columns in table '{{shop_admin_categories}}':
 * @property integer $id
 ...
 */
class ShopAdminCategories extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, price_discount', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('parentId, id, root, lft, rgt, level, parent_id, name, price_discount', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ShopAdminCategories the static model class
	 */
