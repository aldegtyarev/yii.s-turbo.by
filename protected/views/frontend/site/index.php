...
<p>1. Установка продукции должна производится только квалифицированным специалистом (СТО) , имеющим сертификат соответствия на данный вид работ.</p>
<p>2. В случае, если продукция устанавливалась на автомобиль, необходимо предоставить следующие документы:<br>
- копию (оригинал) заказ-наряда (с датой установки) СТО, где производилась установка продукции на автомобиль.<br>
- копию сертификата соответствия (с указанием автомобилей) на оказание услуг предоставляемых СТО.<br>
- заявка на брак, (заключение СТО о неисправности продукции).
</p>
<ol>
	<li>
	<p>Установка продукции должна производится только квалифицированным специалистом (СТО) , имеющим сертификат соответствия на данный вид работ.</p>
	</li>
	<li>
	<p>Установка продукции должна производится только квалифицированным специалистом (СТО) , имеющим сертификат соответствия на данный вид работ.</p>

	<ul>
		<li>копию (оригинал) заказ-наряда (с датой установки) СТО, где производилась установка продукции на автомобиль.</li>
		<li>копию сертификата соответствия (с указанием автомобилей) на оказание услуг предоставляемых СТО.</li>
		<li>заявка на брак, (заключение СТО о неисправности продукции).</li>
	</ul>
	</li>
</ol>
