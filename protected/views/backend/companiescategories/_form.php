...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php //echo $form->dropDownList($model,'dropDownListTree',array('size'=>60,'maxlength'=>255)); ?>
		<?
		
		echo $form->dropDownList(
				$model,
				'parentId',
				$model->DropDownlistData
				//$htmlOptions = array()
			);
		
			
			//CHtml::dropDownList($name = 'parent_level', $selected, $list_data, $htmlOptions = array());			
		?>
