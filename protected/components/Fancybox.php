 ...
 * 
 */
class plgContentMavikThumbnailsDecoratorFancybox extends plgContentMavikThumbnailsDecorator
{
	/**
	...
	function decorate() {
		...
		return '<a style="'. $style .'" class="' . $class . '" href="' . $this->plugin->originalSrc . '" rel="group" title="' . $title . '" target="_blank">' . $img->toString() . $zoominImg . '</a>';
	}	
